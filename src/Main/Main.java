...
public class Main {
	...
	public Main() {
		...
		addNewObject(new Sphere(3.1e22, new MyVector(0, 1.84e10, 0), new MyVector(3014.9, 30000, 0), Color.BLUE, 4737000, "moon"));
		addNewObject(new Sphere(1.989e30, new MyVector(1.49604618e11, 0, 0), new MyVector(0, 0, 0), Color.YELLOW, 696300000, "sun"));		//addNewObject(new Sphere(1.989e33, new MyVector(0, 9.49604618e11, 0), new MyVector(0, 0, 0), Color.GRAY, 50, "earth"));

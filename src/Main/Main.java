...
public class Main {
	...
	public Main() {
		...
		addNewObject(new Sphere(3.1e22, new MyVector(0, 3.84e8, 0), new MyVector(1014.9, 30000, 0), Color.BLUE, 2, "moon"));
		addNewObject(new Sphere(1.989e30, new MyVector(1.49604618e11, 0, 0), new MyVector(0, 0, 0), Color.YELLOW, 50, "earth"));
